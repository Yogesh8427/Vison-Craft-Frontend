...
function AdminOrdercards({ product }) {
    return (
        <div>
            <div className="container-sm border rounded-pill p-3 d-flex justify-content-around my-1">
                ...
                <div className='px-3 d-flex justify-content-around py-1' style={{ width: "70%" }}>
                    ...
                    <p><b>Item Id:  </b><b className='text-primary'>{product.item_id}</b></p>
                    ...
                    <div className='p-1' style={{ width: "50%" }}>
                        <p><b>Total Amount: {product.Price} X {product.Quantity} =</b>
                            <b className='text-success'>₹{product.Price * product.Quantity}</b></p>
                    </div>
                </div>
            </div>
        </div>
